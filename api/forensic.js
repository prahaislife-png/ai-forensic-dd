...
export default async function handler(req, res) {
  try {
    ...
    const promptWithScreening = [
      ...
      "• Do not infer or conclude financial status unless it is explicitly stated in evidence.",
      "• Business directories (e.g., ZoomInfo, Clutch, RocketReach, IndiaMART) can only support profile details such as services, employee counts, and website data.",
      "• If financial data is unavailable in evidence, write exactly:",
      "\"No verifiable financial disclosures were identified in the available evidence sources.\"",
      "• Avoid speculative or implied financial conclusions.",
      ...
      "Risk Conclusion",
      "",
      "Risk Breakdown must appear immediately before Risk Conclusion.",
      "Risk Breakdown must be a table using only LOW, MEDIUM, or HIGH labels.",
      ...
      "Media Reputation",
      "Legal / Regulatory Issues",
      "Do NOT add, remove, or rename Risk Breakdown categories.",
      "Each Risk Breakdown label must be grounded in the provided evidence.",
      ...
      "Do not infer financial health, debt status, profitability, or funding unless directly evidenced.",
      "If evidence does not provide financial disclosures, include this exact sentence in the appropriate section: \"No verifiable financial disclosures were identified in the available evidence sources.\"",
      "",
